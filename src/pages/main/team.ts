    ...
    this.team = [
      {
        ...
        role: 'Developer',
        contribution:
          'Отвечала за создание и дизайн электронного учебника, навигацию по разделам и страницам учебника. Разработала страницу статистики и "Словарь" авторизованного пользоваетля, так же отвечала за функциональность вышеупомянутых компонентов. Настроила BackEnd и работу с ним.',
      },
      {
